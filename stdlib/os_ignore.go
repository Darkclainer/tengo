...
var osModule = map[string]tengo.Object{
	...
	"chdir": &tengo.UserFunction{
		Name:  "chdir",
		Value: ToCallableFunc(os.Chdir),
	}, // chdir(dir string) => error
	"chmod": ToCallableFunc(os.Chmod), // chmod(name string, mode int) => error
	"chown": &tengo.UserFunction{
		Name:  "chown",
		Value: ToCallableFunc(os.Chown),
	}, // chown(name string, uid int, gid int) => error
	"clearenv": &tengo.UserFunction{
		Name:  "clearenv",
		Value: ToCallableFunc(os.Clearenv),
	}, // clearenv()
	"environ": &tengo.UserFunction{
		Name:  "environ",
		Value: ToCallableFunc(os.Environ),
	}, // environ() => array(string)
	"exit": &tengo.UserFunction{
		Name:  "exit",
		Value: ToCallableFunc(os.Exit, 0),
	}, // exit(code int)
	...
	"getegid": &tengo.UserFunction{
		Name:  "getegid",
		Value: ToCallableFunc(os.Getegid),
	}, // getegid() => int
	"getenv": &tengo.UserFunction{
		Name:  "getenv",
		Value: ToCallableFunc(os.Getenv),
	}, // getenv(s string) => string
	"geteuid": &tengo.UserFunction{
		Name:  "geteuid",
		Value: ToCallableFunc(os.Geteuid),
	}, // geteuid() => int
	"getgid": &tengo.UserFunction{
		Name:  "getgid",
		Value: ToCallableFunc(os.Getgid),
	}, // getgid() => int
	"getgroups": &tengo.UserFunction{
		Name:  "getgroups",
		Value: ToCallableFunc(os.Getgroups),
	}, // getgroups() => array(string)/error
	"getpagesize": &tengo.UserFunction{
		Name:  "getpagesize",
		Value: ToCallableFunc(os.Getpagesize),
	}, // getpagesize() => int
	"getpid": &tengo.UserFunction{
		Name:  "getpid",
		Value: ToCallableFunc(os.Getpid),
	}, // getpid() => int
	"getppid": &tengo.UserFunction{
		Name:  "getppid",
		Value: ToCallableFunc(os.Getppid),
	}, // getppid() => int
	"getuid": &tengo.UserFunction{
		Name:  "getuid",
		Value: ToCallableFunc(os.Getuid),
	}, // getuid() => int
	"getwd": &tengo.UserFunction{
		Name:  "getwd",
		Value: ToCallableFunc(os.Getwd),
	}, // getwd() => string/error
	"hostname": &tengo.UserFunction{
		Name:  "hostname",
		Value: ToCallableFunc(os.Hostname),
	}, // hostname() => string/error
	"lchown": &tengo.UserFunction{
		Name:  "lchown",
		Value: ToCallableFunc(os.Lchown),
	}, // lchown(name string, uid int, gid int) => error
	"link": &tengo.UserFunction{
		Name:  "link",
		Value: ToCallableFunc(os.Link),
	...
	"exec_look_path": &tengo.UserFunction{
		Name:  "exec_look_path",
		Value: ToCallableFunc(exec.LookPath),
